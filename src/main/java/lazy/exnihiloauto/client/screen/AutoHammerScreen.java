        ...
        if(this.hoveredSlot != null) {
            if(!this.hoveredSlot.getHasStack()) {
                if(this.hoveredSlot.slotNumber == 1) {
                    this.renderTooltip(matrixStack, new StringTextComponent("Input(Hammarable Block)"), mouseX, mouseY);
                } else if(this.hoveredSlot.slotNumber == 0) {
                    this.renderTooltip(matrixStack, new StringTextComponent("Hammer"), mouseX, mouseY);
                }
            } else {
